...
client.on('ready', function(){    
    var ms = 100000 ;
    var prefix = "-"; 
    var setGame = [`New Bot`,`Beta 0.9`,`yay`];
    var i = -1;    
    var j = 0;    
...
if(msg.author.id !== '504707359751536640') return;
    msg.reply('Done :)');
  }
});
...
if (m.id == '504707359751536640') return;
...
client.channels.get("491351040856162325").send(`:white_check_mark: **${client.user.tag} دخل سيرفر جديد
...
client.on('guildDelete', guild => {
  client.channels.get("491351040856162325").send(`:negative_squared_cross_mark: **${client.user.tag} طلع من سيرفر
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
